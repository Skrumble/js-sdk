...
describe("APISocket", () => {
  ...
  it("has a path property for the API", () => {
    ...
    assert.property(
      Socket,
      "api_url",
      "api_url property exists on Socket object"
    );
    assert.typeOf(
      Socket.api_url,
      "string",
      "api_url property is of type string"
    );
  });
  ...
  it("defaults API path to production", () => {
    ...
    assert.equal(
      ...
      "api_url property defaults to the production API url"
    );
  });
  ...
  it("has properties for auth and refresh tokens", () => {
    ...
    assert.property(
      Socket,
      "auth_token",
      "auth_token property exists on Socket 'object'"
    );
    assert.property(
      Socket,
      "refresh_token",
      "refresh_token property exists on Socket 'object'"
    );
    assert.typeOf(
      Socket.auth_token,
      "string",
      "auth_token property is of type 'string'"
    );
    assert.typeOf(
      Socket.refresh_token,
      "string",
      "refresh_token property is of type 'string'"
    );
  });
  ...
  it("has a property for the socket that defaults to false", () => {
    ...
    assert.property(
      Socket,
      "socket",
      "socket property exists on Socket object"
    );
    assert.typeOf(
      Socket.socket,
      "boolean",
      "socket property is of type boolean"
    );
  ...
  describe("off", () => {
    ...
    it(
      "if the function is omitted then stops calling all listeners of the type"
    );
  });
});
